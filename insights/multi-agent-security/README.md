...
![MASO Architecture](diagrams/maso-architecture.svg)
...
![PACE Multi-Agent Cycle](diagrams/pace-multi-agent-cycle.svg)
...
![OWASP Dual Mapping](diagrams/owasp-dual-mapping.svg)
